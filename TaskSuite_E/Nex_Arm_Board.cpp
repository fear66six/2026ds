...
void OLED_t::show_status(float x, float y, float z, float pitch, float roll, float claw)
{
    ...
    do {
        ...
        u8g2.setFont(u8g2_font_6x10_tr);
        u8g2.setCursor(0, 25);
        u8g2.print("X:"); u8g2.print(x, 0);
        u8g2.setCursor(64, 25);
        u8g2.print("Y:"); u8g2.print(y, 0);
        
        u8g2.setCursor(0, 40);
        u8g2.print("Z:"); u8g2.print(z, 0);
        u8g2.setCursor(64, 40);
        u8g2.print("P:"); u8g2.print(pitch, 1);
        
        u8g2.setCursor(0, 55);
        u8g2.print("R:"); u8g2.print(roll, 0);
        u8g2.setCursor(64, 55);
        u8g2.print("C:"); u8g2.print(claw, 0);
...
void OLED_t::show_espnow_info(uint8_t channel, uint8_t acc, bool is_unicast, String mac)
{
    ...
    do {
        ...
        u8g2.setCursor(0, 35);
        u8g2.print("Mode: "); u8g2.print(is_unicast ? "Private" : "Broadcast");
  ...
  while(file.available()) {
      ...
      for(uint8_t i = 0; i < servo_num; i++) {
        ...
        if(s_id >= 1 && s_id <= 6) {
            ...
            servo.write_pos_ex(s_id, s_acc, (int16_t)calc_speed, (int16_t)s_pos);
