"""Q2 top-level workflow using the completed Q1 hardware executors."""
...
class RunRecorder:
    def __init__(self, root: Path, mode: str, config: Q2RuntimeConfig) -> None:
    ...
    def announce(self, *, prefix: str = "Q2_RUN") -> None:
...
class Q2Controller:
    ...
    def _capture_and_plan(self) -> WhitePuzzleScene:
        states = {
        ...
        try:
            ...
            if self.move_queue:
                self._transition(
                    ...
                    len(self.move_queue),
                    reason="return HOME after final Q2 fragment",
                )
            ...
            self.recorder.write(
                ...
                {
                    "completed": True,
                    "completion_basis": "Q2 move queue exhausted",
            ...
            self.recorder.announce(prefix="Q2_FAILED_RUN")
            raise
        finally:
