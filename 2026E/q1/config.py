...
CAMERA_HEIGHT = 480
CAMERA_FPS = 30.0
CAMERA_FOURCC = "MJPG"        # 不支持时后端可忽略；启动诊断会打印实际值
CAMERA_BACKEND = "auto"
CAMERA_AUTO_EXPOSURE = None   # None=保持设备默认，不做未经验证的写入
CAMERA_EXPOSURE = None
CAMERA_GAIN = None
DISPLAY_SCALE = 0.65
OPENCV_NUM_THREADS = None      # None=保持 OpenCV 默认；Jetson 上用基准比较 1/2/4
...
LIVE_PAPER_MAX_AGE_S = 8.0
LIVE_PAPER_CHANGE_THRESHOLD = 12.0
CAMERA_READ_FAILURE_LIMIT = 10
CAMERA_READ_RETRY_DELAY_S = 0.02
